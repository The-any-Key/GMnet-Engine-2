...
if point_in_rectangle(mouse_x,mouse_y,300,400,400,430) event_perform(ev_keyboard,ord("N"));
draw_set_colour(c_yellow);
draw_text(300,440,string_hash_to_newline(text3));
if point_in_rectangle(mouse_x,mouse_y,300,440,400,470) event_perform(ev_keyboard,ord("B"));
draw_set_colour(c_fuchsia);
draw_text(300,480,string_hash_to_newline(text4));
if point_in_rectangle(mouse_x,mouse_y,300,480,400,510) event_perform(ev_keyboard,ord("K"));
draw_set_colour(c_aqua);
draw_text(300,520,string_hash_to_newline(text5));
if point_in_rectangle(mouse_x,mouse_y,300,520,400,550) event_perform(ev_keyboard,ord("L"));
